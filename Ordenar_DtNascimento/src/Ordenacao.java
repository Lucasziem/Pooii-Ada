...
//
        ...
        System.out.println("Lista desordenada %s".formatted(listaNumeros));
        Collections.sort(listaNumeros);
        System.out.println("Lista ordenada %s".formatted(listaNumeros));
        ...
        System.out.println("a.compareTo(A) == %s".formatted("a".compareTo("A")));
